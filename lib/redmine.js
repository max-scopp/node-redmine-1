 ...
 */
 // TESTME
Redmine.prototype.getGroups = function(callback) {
  rest.get(this.getHost()+'/groups.json', {headers:this.getHeader()}).on('complete', callback);
};

Redmine.prototype.getGroup = function(id, format, callback) {
  rest.get(this.getHost()+'/groups/' + id + '.json', {query:format, headers:this.getHeader()}).on('complete', callback);
};
...
Redmine.prototype.updateGroup   = function(id, params, format, callback) {
  rest.put(this.getHost()+'/groups/' + id + '.json', {query:format, data:JSON.stringify({group: params}), headers:this.getHeader()}).on('complete', callback);
};

Redmine.prototype.deleteGroup = function(id, format, callback) {
  rest.del(this.getHost()+'/groups/' + id + '.json', {query:format, headers:this.getHeader()}).on('complete', callback);
};
